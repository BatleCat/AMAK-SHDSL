/*******************************************************************************
  ...
  Description:
    ...
    "APP_SERVICE_UART_TASK_Initialize" and "APP_SERVICE_UART_TASK_Tasks" prototypes) and some of them are only used
    internally by the application (such as the "APP_SERVICE_UART_TASK_STATES" definition).  Both
    are defined here for convenience.
*******************************************************************************/

#ifndef _APP_SERVICE_UART_TASK_H
#define _APP_SERVICE_UART_TASK_H
...
/*******************************************************************************
  ...
  Description:
    ...
    APP_SERVICE_UART_TASK_Tasks function can be called.
...
#endif /* _APP_SERVICE_UART_TASK_H */
