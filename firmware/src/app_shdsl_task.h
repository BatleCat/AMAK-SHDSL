/*------------------------------------------------------------------------------
  ...
  Description:
    ...
    "APP_SHDSL_TASK_Initialize" and "APP_SHDSL_TASK_Tasks" prototypes) and some of them are only used
    internally by the application (such as the "APP_SHDSL_TASK_STATES" definition).  Both
    are defined here for convenience.
------------------------------------------------------------------------------*/

#ifndef _APP_SHDSL_TASK_H
#define _APP_SHDSL_TASK_H
...
typedef enum
{
    ...
    APP_SHDSL_TASK_STATE_INIT=0,
    APP_SHDSL_TASK_STATE_SERVICE_TASKS,
    /* TODO: Define states used by the application state machine. */

} APP_SHDSL_TASK_STATES;
//------------------------------------------------------------------------------
...
/*------------------------------------------------------------------------------
  ...
  Description:
    ...
    APP_SHDSL_TASK_Tasks function can be called.
